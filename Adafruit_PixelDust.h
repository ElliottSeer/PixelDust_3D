...
typedef struct {
  ...
  velocity_t vz; ///< Depth velocity (-255 to +255) in 'sand space'
} Grain;
...
public:
  /*!
      ...
      @param d    Simulation depth in pixels (same).
  ...
  */
  void setPixel(dimension_t x, dimension_t y, dimension_t z);
  ...
  /*!
      ...
      @param y Vertical (y) coordinate (0 to height-1).
  */
  void clearPixel(dimension_t x, dimension_t y, dimension_t z);
  ...
  */
  ...
  /*!
      ...
      @return true if spot occupied by a grain or obstacle,
              otherwise false.
  */
  bool getPixel(dimension_t x, dimension_t y, dimension_t z) const;
  ...
  */
  bool setPosition(grain_count_t i, dimension_t x, dimension_t y, dimension_t z);
  ...
  */
  void getPosition(grain_count_t i, dimension_t *x, dimension_t *y, dimension_t *z) const;
  ...
  */
  void iterate(int16_t ax, int16_t ay, int16_t az);
...
private:
  ...
  position_t xMax,        // Max X coordinate in grain space
      ...
      zMax;               // Max Z coordinate in grain space
